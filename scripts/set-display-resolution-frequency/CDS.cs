...
namespace cds
{
    ...
    public class Helper
    {
        ...
        /// <returns></returns>
        public static string ChangeDisplaySettings(int width, int height, int frequency, Flags flags)
        {
            return ChangeDisplaySettings(width, height, frequency, flags, out var _);
        }
        ...
        /// <returns></returns>
        public static string ChangeDisplaySettings(int width, int height, int frequency, Flags flags, out bool success)
        {
